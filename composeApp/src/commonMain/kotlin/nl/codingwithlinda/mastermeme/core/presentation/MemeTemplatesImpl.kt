...
object MemeTemplatesImpl: MemeTemplates {
    override fun getTemplates(): List<MemeImageUi> {
       return listOf(
        ...
        MemeImageUi.pngImage(Res.drawable._0_2reqtg),
        ...
        MemeImageUi.pngImage(Res.drawable._2_1yz6z4),
        MemeImageUi.pngImage(Res.drawable._2_2eb198),
        MemeImageUi.pngImage(Res.drawable._2_3eqjd8),
        MemeImageUi.pngImage(Res.drawable._2_7wxtd1),
        MemeImageUi.pngImage(Res.drawable._3_2byuiy),
        MemeImageUi.pngImage(Res.drawable._3__43iacv),
        MemeImageUi.pngImage(Res.drawable._3_jack_sparrow_being_chased),
        MemeImageUi.pngImage(Res.drawable._3_waiting_skeleton),
        MemeImageUi.pngImage(Res.drawable._4_1jgrgn),
        MemeImageUi.pngImage(Res.drawable._4_leonardo_dicaprio_cheers),
        MemeImageUi.pngImage(Res.drawable._4_running_away_balloon),
        MemeImageUi.pngImage(Res.drawable._4_scared),
        MemeImageUi.pngImage(Res.drawable._5_1op9wy),
        MemeImageUi.pngImage(Res.drawable._5_24zoa8),
        MemeImageUi.pngImage(Res.drawable._5_58eyvu),
        MemeImageUi.pngImage(Res.drawable._5_i_was_told_there_would_be),
        MemeImageUi.pngImage(Res.drawable._6_2t8r9a),
